...
if __name__ == '__main__':
    ...
    pet_beacon = HttpPetDetection(ip, callback=pet_detector_callback, display=False)
    pet_beacon.start()

    april_beacon = HttpAprilResolver(ip, callback=beacon_resolver_callback, display=False)
